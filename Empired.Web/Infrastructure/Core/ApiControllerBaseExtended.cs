...
namespace Empired.Web.Infrastructure.Core
{
    public class ApiControllerBaseExtended : ApiController
    {
        ...
        protected IEntityBaseRepository<Patient> _customersRepository;
        ...
        private void InitRepositories(List<Type> entities)
        {
            ...
            if (entities.Any(e => e.FullName == typeof(Patient).FullName))
            {
                _customersRepository = _dataRepositoryFactory.GetDataRepository<Patient>(RequestMessage);
            }
