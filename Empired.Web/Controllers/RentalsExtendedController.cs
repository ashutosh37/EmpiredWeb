...
namespace Empired.Web.Controllers
{
    ...
    public class RentalsExtendedController : ApiControllerBaseExtended
    {
        ...
        {
            _requiredRepositories = new List<Type>() { typeof(Patient), typeof(Stock), typeof(Rental) };
        ...
        {
            _requiredRepositories = new List<Type>() { typeof(Patient), typeof(Stock), typeof(Rental), typeof(Patient), typeof(Movie) };
