(function (app) {
    ...
    app.controller('patientsCtrl', patientsCtrl);

    patientsCtrl.$inject = ['$scope','$modal', 'apiService', 'notificationService'];

    function patientsCtrl($scope, $modal, apiService, notificationService) {
        ...
        function search(page) {
            ...
            apiService.get('/api/patients/search/', config,
        ...
        function openEditDialog(customer) {
            ...
            $modal.open({
                templateUrl: 'scripts/spa/patients/editCustomerModal.html',
