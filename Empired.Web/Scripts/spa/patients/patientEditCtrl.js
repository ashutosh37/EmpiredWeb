(function (app) {
    ...
    app.controller('patientEditCtrl', patientEditCtrl);

    patientEditCtrl.$inject = ['$scope', '$modalInstance', '$timeout', 'apiService', 'notificationService'];

    function patientEditCtrl($scope, $modalInstance, $timeout, apiService, notificationService) {
        ...
        function updateCustomer()
        {
            ...
            apiService.post('/api/patients/update/', $scope.EditedCustomer,
