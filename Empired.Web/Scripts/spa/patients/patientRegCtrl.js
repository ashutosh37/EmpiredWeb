(function (app) {
    ...
    app.controller('patientsRegCtrl', patientsRegCtrl);

    patientsRegCtrl.$inject = ['$scope', '$location', '$rootScope', 'apiService'];

    function patientsRegCtrl($scope, $location, $rootScope, apiService) {
        ...
        function Register() {
            apiService.post('/api/patients/register', $scope.newCustomer,
